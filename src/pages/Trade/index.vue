  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in addressInfo" :key="address.id">
        ...
        <p @click="isSelected(address, addressInfo)">
      ...
      <div class="address clearFix">
        <span class="username" @click="payMethod = 'online'" :class="{'selected': payMethod == 'online'}">在线支付</span>
        <span class="username" @click="payMethod = 'cash'" :class="{ 'selected': payMethod == 'cash' }" style="margin-left:5px;">货到付款</span>
      </div>
      <div class="line"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      isSelected(address, addressInfo) {
